...
<ToolsWrapper
  cards={[
    ...
    },
    {
      ...
      imageUrl: "/img/gcd_standalone2.png",
      toolUrl: "https://github.com/Riverscapes/gcd/releases/latest",
    ...
    {
      title: "GCD 7 Viewer for ArcGIS Pro",
      imageUrl: "/img/gcd_arcpro_viewer.png",
      description: "An AddIn for ArcGIS Pro for viewing GCD 7 projects. This version does not perform any analyses, but allows users to visualize GCD 7 project inputs and outputs within ArcGIS Pro.",
    }
  ]}
  cardsize="sm"
/>
