...
- Applying consistent assembly versions to all binaries and the Microsoft Store Submission
- Fixing Help menu and about screen links
- Changing main form icon to the new GCD logo.
