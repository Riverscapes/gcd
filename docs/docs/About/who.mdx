...
<LogoWrapper
  logos={[
    { imageUrl: "https://docs.riverscapes.net/img/people/joe_wheaton.png", name:'Joe Wheaton' },
    { imageUrl: "https://docs.riverscapes.net/img/people/james_brasington.png", name:'James Brasington' },
    { imageUrl: "https://docs.riverscapes.net/img/people/philip_bailey.png", name:'Philip Bailey' },
    { imageUrl: "https://docs.riverscapes.net/img/people/matt_reimer.png", name:'Matt Reimer' },
  ]}
  size="sm"
/>
...
The GCD software was originally developed by [Joe Wheaton](http://www.joewheaton.org) ([Utah State University Department of Watershed Sciences](http://qcnr.usu.edu/wats/)) and [James Brasington](https://www.waterways.ac.nz/james-brasington) ([Waterways at University of Canterbury, New Zealand](https://www.waterways.ac.nz/)). Joe and James began collaborating on geomorphic change detection in 2004 during Joe's PhD. During his Master's with [Greg Pasternack](http://pasternack.ucdavis.edu/), Joe used James' early work in topographic change detection and surveying (Brasington et al. 2001, 2003). They soon developed the first version of GCD (DoD 1) in Matlab. Originally meant for Joe's workflow, it quickly proved helpful for the broader geomorphology community.
...
In 2009, at Utah State University, Joe connected with [Paul Grams](https://www.usgs.gov/staff-profiles/paul-grams) and received funding for GCD 4. At a 2010 NSF LiDAR workshop, Joe met [Philip Bailey](http://northarrowresearch.com/#people), then at [ESSA](https://essa.com). Joe was teaching [DoD 3](https://github.com/joewheaton/DoD); Philip, the River Bathymetry Toolkit. Their shared background sparked collaboration, and they have worked on GCD ever since.
