...
The GCD [devleopment team](https://gcd.riverscapes.net/About/who.html) are not actively seeking funding to build a **Commercial-Grade**  version of GCD, but they hope to do so in the next 2 to 5 years. A commercial grade version of GCD has been demo'd, and it  would:
