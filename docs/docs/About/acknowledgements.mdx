...
Original funding for GCD 7 was provided by the [NERC GeoTERM project](https://nerc.ukri.org/research/funded/programmes/geoterm/) (NE/T000341/1) and the [USGS Grand Canyon Monitoring and Research Center (GCMRC)](https://www.gcmrc.gov/gcmrc.aspx) under Interagency Agreement number G19AC00008.

The GCD 7 AddIn for ArcGIS Pro development was supported by Auckland Regional Council and the Waterways Centre for Freshwater Management at the University of Canterbury.
...
<LogoWrapper
  logos={[
    ...
    { imageUrl: "/img/logos/auckland_logo.svg", url: "https://www.aucklandcouncil.govt.nz" },
    { imageUrl: "/img/logos/waterways.png", url: "https://www.canterbury.ac.nz" }
  ]}
  size="sm"
/>
<br /><br />
