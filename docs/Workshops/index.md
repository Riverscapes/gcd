...
| 2018, Spring | [Fluvial Geomorphology WATS 5150]({{ site.baseurl }}/Workshops/2019/wats5150/) <i class="fa fa-calendar" aria-hidden="true"></i> | Logan, UT | [Utah State University](http://qcnr.usu.edu/wats//) |
...
<div class="row small-up-2 medium-up-3 large-up-4" align="center">
  ...
  <div class="column column-block">
    <a class="hollow button" href="{{ site.baseurl }}/Workshops/About/how-to-register"> <i class="fa fa-sign-in" aria-hidden="true"></i> Registration </a>
  </div>
  <div class="column column-block">
  ...
  <div class="column column-block">
    <a class="hollow button" href="{{ site.baseurl }}/Workshops/About/wsprerequisites"><i class="fa fa-puzzle-piece" aria-hidden="true"></i> Course & Workshop Prerequisties</a>
  </div>
  <div class="column column-block">
    <a class="hollow button" href="{{ site.baseurl }}/Workshops/About/text-readings"><i class="fa fa-book" aria-hidden="true"></i> Reccomended Readings</a>
  </div>
  <div class="column column-block">
    <a class="hollow button" href="{{ site.baseurl }}/Workshops/About/logan-venue"><i class="fa fa-map" aria-hidden="true"></i> Logan Venue</a>
  </div>
  <div class="column column-block">
