...
Namespace GISCode.GCD
    ...
    Public Class DoDHistogramViewerClass
        Private _ZedGraph As ZedGraph.ZedGraphControl
        ...
        Public Sub New(ByVal Zedgraph As ZedGraph.ZedGraphControl, ByVal sUnits As String)
            _ZedGraph = Zedgraph
            m_sUnits = sUnits
        ...
        Public Sub refresh(ByVal dRawHistogram As Dictionary(Of Double, Double),
                           ...
                           ByVal eUnits As NumberFormatting.LinearUnits)
            ...
            Pane1.XAxis.Title.Text = "Elevation Change" & GISCode.NumberFormatting.GetUnitsAsString(eUnits, True)

            'Get proper label and subscripted units for y-axis
            If bArea Then
                Pane1.YAxis.Title.Text = "Area " & GISCode.NumberFormatting.GetUnitsAsString(eUnits, True, 2)
            Else
                Pane1.YAxis.Title.Text = "Volume " & GISCode.NumberFormatting.GetUnitsAsString(eUnits, True, 3)
            End If
        ...
        Public Sub ExportCharts(ByVal changeHisto As GCD.ChangeDetection.DoDResultHistograms, ByVal theUnits As GISCode.LinearUnitClass, ByVal AreaGraphPath As String, ByVal VolumeGraphPath As String, ByVal ChartWidth As Integer, ByVal ChartHeight As Integer)
            ...
            'Save histograms
            Dim myZedGraphControl As New ZedGraph.ZedGraphControl
        ...
        Public Sub Save(ByVal GraphPath As String, ByVal ChartWidth As Integer, ByVal ChartHeight As Integer)
            _ZedGraph.GraphPane.GetImage(ChartWidth, ChartHeight, 300).Save(GraphPath)
