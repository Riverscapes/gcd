...
#End If
        ...
        Private Sub RefreshGridView()
            ...
            If m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.ShowAll OrElse
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Area of Erosion (" & UnitsNet.Area.GetAbbreviation(m_Options.AreaUnits) & ")" 'the superscript 2 is ALT+0178
                aRow.Cells(0).ToolTipText = "The amount of area experiencing erosion"
                aRow.Cells(1).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaErosion_Raw, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaErosion_Thresholded, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Area of Deposition (" & UnitsNet.Area.GetAbbreviation(m_Options.AreaUnits) & ")"
                aRow.Cells(0).ToolTipText = "The amount of area experiencing deposition"
                aRow.Cells(1).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaDeposition_Raw, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaDeposition_Thresholded, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
                aRow.Cells(3).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(4).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(5).Style.BackColor = Drawing.Color.LightGray
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Area of Detectable Change (" & UnitsNet.Area.GetAbbreviation(m_Options.AreaUnits) & ")"
                aRow.Cells(0).ToolTipText = "The sum of areas experiencing detectable erosion and deposition"
                aRow.Cells(1).Value = "NA"
                aRow.Cells(2).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaDetectableChange_Thresholded, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
                aRow.Cells(3).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(4).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(5).Style.BackColor = Drawing.Color.LightGray
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Area of Interest (" & UnitsNet.Area.GetAbbreviation(m_Options.AreaUnits) & ")"
                aRow.Cells(0).ToolTipText = "The total amount of area under analysis (including detectable and undetectable)"
                aRow.Cells(1).Value = UnitsNet.Area.From(m_DoDResultSet.ChangeStats.AreaOfInterest_Raw, eAreaUnitsNotImplemented).As(m_Options.AreaUnits).ToString(sFormat)
            ...
            If m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.ShowAll OrElse
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Volume of Erosion (" & UnitsNet.Volume.GetAbbreviation(m_Options.VolumeUnits) & ")" 'the superscript 3 is ALT+0179
                aRow.Cells(0).ToolTipText = "On a cell-by-cell basis, the DoD erosion depth multiplied by cell area and summed"
                aRow.Cells(1).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeErosion_Raw, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeErosion_Thresholded, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeErosion_Error, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(5).Value = m_DoDResultSet.ChangeStats.VolumeOfErosion_Percent.ToString(sFormat)

                'Volume of deposition
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Volume of Deposition (" & UnitsNet.Volume.GetAbbreviation(m_Options.VolumeUnits) & ")"
                aRow.Cells(0).ToolTipText = "On a cell-by-cell basis, the DoD deposition depth multiplied by cell area and summed"
                aRow.Cells(1).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeDeposition_Raw, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeDeposition_Thresholded, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeDeposition_Error, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(5).Value = m_DoDResultSet.ChangeStats.VolumeOfDeposition_Percent.ToString(sFormat)

                'Total volume of difference
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Volume of Difference (" & UnitsNet.Volume.GetAbbreviation(m_Options.VolumeUnits) & ")"
                aRow.Cells(0).ToolTipText = "The sum of erosion and deposition volumes (a measure of total turnover)"
                aRow.Cells(1).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeOfDifference_Raw, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeOfDifference_Thresholded, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.VolumeOfDifference_Error, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
            ...
            (m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.SpecificGroups AndAlso m_Options.m_bRowsVolumetric) Then
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Total Net Volume Difference (" & UnitsNet.Volume.GetAbbreviation(m_Options.VolumeUnits) & ")"
                aRow.Cells(0).ToolTipText = "The net difference of erosion and depostion volumes (i.e. deposition minus erosion)"
                aRow.Cells(1).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.NetVolumeOfDifference_Raw, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.NetVolumeOfDifference_Thresholded, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Volume.From(m_DoDResultSet.ChangeStats.NetVolumeOfDifference_Error, eVolUnitsNotImplemented).As(m_Options.VolumeUnits).ToString(sFormat)
            ...
            If m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.ShowAll OrElse
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Depth of Erosion (" & UnitsNet.Length.GetAbbreviation(m_Options.LinearUnits) & ")"
                aRow.Cells(0).ToolTipText = "The average depth of erosion (erosion volume dividied by erosion area)"
                aRow.Cells(1).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthErosion_Raw, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthErosion_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthErosion_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(5).Value = m_DoDResultSet.ChangeStats.AverageDepthErosion_Percent.ToString(sFormat)

                ' Average Depth of Deposition
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Depth of Deposition (" & UnitsNet.Length.GetAbbreviation(m_Options.LinearUnits) & ")"
                aRow.Cells(0).ToolTipText = "The average depth of deposition (deposition volume dividied by deposition area)"
                aRow.Cells(1).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthDeposition_Raw, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthDeposition_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageDepthDeposition_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Total Thickness of Difference (" & UnitsNet.Length.GetAbbreviation(m_Options.LinearUnits) & ") for Area of Interest"
                ...
                aRow.Cells(1).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageThicknessOfDifferenceAOI_Raw, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageThicknessOfDifferenceAOI_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageThicknessOfDifferenceAOI_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
            ...
            If m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.ShowAll OrElse
             ...
             (m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.SpecificGroups AndAlso m_Options.m_bRowsVerticalAverages) Then
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Net Thickness of Difference (" & UnitsNet.Area.GetAbbreviation(m_Options.LinearUnits) & ") for Area of Interest"
                ...
                aRow.Cells(1).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageNetThicknessofDifferenceAOI_Raw, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageNetThicknessOfDifferenceAOI_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageNetThicknessOfDifferenceAOI_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
         ...
         m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.SpecificGroups AndAlso m_Options.m_bRowsVerticalAverages Then
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Total Thickness of Difference (" & UnitsNet.Length.GetAbbreviation(m_Options.LinearUnits) & ") for Area with Detectable Change"
                ...
                aRow.Cells(1).Value = "NA"
                aRow.Cells(1).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageThicknessOfDifferenceADC_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageThicknessOfDifferenceADC_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
            ...
            If m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.ShowAll OrElse
              ...
              (m_Options.m_eRowGroups = DoDSummaryDisplayOptions.RowGroups.SpecificGroups AndAlso m_Options.m_bRowsVerticalAverages) Then
                ...
                nIndex = grdData.Rows.Add(1)
                aRow = grdData.Rows(nIndex)
                aRow.Cells(0).Value = "Average Net Thickness of Difference (" & UnitsNet.Length.GetAbbreviation(m_Options.LinearUnits) & ") for Area with Detectable Change"
                ...
                aRow.Cells(1).Value = "NA"
                aRow.Cells(1).Style.BackColor = Drawing.Color.LightGray
                aRow.Cells(2).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageNetThicknessOfDifferenceADC_Thresholded, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
                aRow.Cells(3).Value = "±"
                aRow.Cells(4).Value = UnitsNet.Length.From(m_DoDResultSet.ChangeStats.AverageNetThicknessOfDifferenceADC_Error, m_DoDResultSet.DoDProperties.Units).As(m_Options.LinearUnits).ToString(sFormat)
