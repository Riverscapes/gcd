Public Class DoDResultsForm
    ...
    Public Sub New(ByRef pArcMap As ESRI.ArcGIS.Framework.IApplication, ByRef dodResult As GCD.ChangeDetection.DoDResultSet, rDoD As ProjectDS.DoDsRow)
    ...
    Private Sub DoDResultsForm_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        ucBars.Initialize(ucHistogram.DoDResultSet.ChangeStats, ucSummary.Options.m_eLinearUnits)
    ...
    Private Sub cmdBrowse_Click(sender As System.Object, e As System.EventArgs) Handles cmdBrowse.Click
        ...
        If TypeOf m_rDoD Is ProjectDS.DoDsRow Then
            Dim sFolder As String = GCD.GCDProject.ProjectManager.GetAbsolutePath(m_rDoD.OutputFolder) ' GCD.GCDProject.ProjectManager.OutputManager.GetDoDOutputFolder(m_rDoD.Name)
