    ...
    Public Class frmDoDProperties
        ...
        Private Sub cmdOK_Click(sender As System.Object, e As System.EventArgs) Handles cmdOK.Click
            ...
            Try
                ...
                Dim gNewDEM As New Core.GISDataStructures.Raster(Core.GCDProject.ProjectManager.GetAbsolutePath(GetDEMRow(cboNewDEM).Source))
                Dim gOldDEM As New Core.GISDataStructures.Raster(Core.GCDProject.ProjectManager.GetAbsolutePath(GetDEMRow(cboOldDEM).Source))

                Dim gAOI As Core.GISDataStructures.Vector = Nothing
                Dim rAOI As ProjectDS.AOIsRow = GetAOIRow()
                If TypeOf rAOI Is ProjectDS.AOIsRow Then
                    gAOI = New Core.GISDataStructures.Vector(Core.GCDProject.ProjectManager.GetAbsolutePath(rAOI.Source))
                End If
