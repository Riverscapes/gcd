...
Namespace UI.BudgetSegregation
    ...
    Public Class MaskStatsViewerClass
        ...
        Private _MaskStats As Core.BudgetSegregation.MaskStatsClass
        ...
        Public Sub New(ByVal grdDetails As DataGridView, ByVal MaskStats As Core.BudgetSegregation.MaskStatsClass, ByVal units As String)
        ...
        Public Sub refresh()
            ...
            Dim stats As Core.ChangeDetection.StatsDataClass = _MaskStats.MaskStats(_MaskName)
