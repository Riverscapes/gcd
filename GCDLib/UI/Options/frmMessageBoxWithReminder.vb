Namespace UI.Options
    Public Class frmMessageBoxWithReminder
        ...
        Public Sub New(sNewWorkspacePath As String) ', bReferenceUserName As Boolean)
            ...
            lblMessage.Text = String.Format("The proposed temporary workspace path ({0}) contains characters that are not recommended.{1}" &
                                              " It is strongly recommended that you choose an alternative path that is near the root of your C drive and that does not contain spaces or periods. Do you want to proceed and use the selected path anyway?",
