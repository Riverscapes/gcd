...
#Region "Events"
    ...
    Private Sub OptionsForm_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Label6.Text = ArcMap.GetArcMapDisplayUnitsAsString(m_pArcMap)
        ...
        Try
            ...
            For Each eType As GCD.RasterPyramidManager.PyramidRasterTypes In [Enum].GetValues(GetType(GCD.RasterPyramidManager.PyramidRasterTypes))
                Dim bPyramids As Boolean = GCD.RasterPyramidManager.AutomaticallyBuildPyramids(eType)
                lstPyramids.Items.Add(New GCD.PyramidRasterTypeDisplay(eType), bPyramids)
            Next
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClose.Click
        ...
        If GCDExtension.GetGCDExtension(m_pArcMap).ValidateWorkspace(txtWorkspace.Text) Then
        ...
        For i As Integer = 0 To lstPyramids.Items.Count - 1
            Dim lItem As GCD.PyramidRasterTypeDisplay = lstPyramids.Items(i)
            GISCode.GCD.RasterPyramidManager.SetAutomaticPyramidsForRasterType(lItem.RasterType, lstPyramids.CheckedIndices.Contains(i))
        Next
        My.Settings.AutomaticPyramids = GISCode.GCD.RasterPyramidManager.GetPyramidSettingString
    ...
    Private Sub btnBrowseChangeWorkspace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBrowse.Click
        ...
        If pFolderBrowserDialog.ShowDialog = DialogResult.OK Then
            If GCDExtension.GetGCDExtension(m_pArcMap).ValidateWorkspace(pFolderBrowserDialog.SelectedPath) Then
    ...
    Private Sub btnClearWorkspace_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClearWorkspace.Click
        ...
        If Not txtWorkspace.Text = WorkspaceManager.WorkspacePath Then
    ...
    Private Sub cmdDefault_Click(sender As System.Object, e As System.EventArgs) Handles cmdDefault.Click
        ...
        Dim sNewWorkspacePath As String = WorkspaceManager.GetDefaultWorkspace(My.Resources.Manufacturer, My.Resources.ApplicationNameShort)
        If GCDExtension.GetGCDExtension(m_pArcMap).ValidateWorkspace(sNewWorkspacePath) Then
            ...
            If TypeOf CurrentRow.Row Is SurveyTypes.SurveyTypesRow Then
                ...
                If response = MsgBoxResult.Yes Then
                    If Not CurrentRow Is Nothing Then
                        ...
                        ProjectManager.saveSurveyTypes()
                    End If
                End If
            End If
        End If
