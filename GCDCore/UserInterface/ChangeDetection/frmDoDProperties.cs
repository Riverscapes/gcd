	...
	public partial class frmDoDProperties
	{
		...
		private void cmdOK_Click(System.Object sender, System.EventArgs e)
		{
			...
			try {
                ...
                {
                    cdEngine = new GCDCore.Engines.ChangeDetectionEngineMinLoD(txtName.Text, dFolder, newDEM, oldDEM, valMinLodThreshold.Value);

                }
                else
                {
                    ErrorSurface newError = (ErrorSurface)cboNewError.SelectedItem;
                    ErrorSurface oldError = (ErrorSurface)cboOldError.SelectedItem;

                    if (rdoPropagated.Checked)
                    {
                        cdEngine = new GCDCore.Engines.ChangeDetectionEnginePropProb(txtName.Text, dFolder, newDEM, oldDEM, newError, oldError);
                    }
                    else
                    {
