...
namespace GCDCore.UserInterface.Project.TreeNodeTypes
{
    public class AssocGroup : TreeNodeGroup
    {
        ...
        {
            SurveyLibrary.frmImportRaster frm = SurveyLibrary.frmImportRaster.PrepareToImportRaster(DEM, SurveyLibrary.ExtentImporter.Purposes.AssociatedSurface, "Associated Surface", new IntPtr(0));
