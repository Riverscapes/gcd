	...
	public partial class frmBudgetSegResults
	{
		...
		private void cmdBrowse_Click(System.Object sender, System.EventArgs e)
		{
			if (BudgetSeg.Folder.Exists) {
				...
				Interaction.MsgBox("The budget segregation folder does not exist: " + BudgetSeg.Folder.FullName, MsgBoxStyle.Information, GCDCore.Properties.Resources.ApplicationNameLong);
			}
		}
