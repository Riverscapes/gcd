...
namespace GCDUserInterface.UI.BudgetSegregation
{
	...
	partial class frmBudgetSegResults : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.ucSummary = new GCDUserInterface.ChangeDetection.ucDoDSummary();
			this.cboSummaryClass = new System.Windows.Forms.ComboBox();
			this.Label2 = new System.Windows.Forms.Label();
			this.TabPage2 = new System.Windows.Forms.TabPage();
			this.TableLayoutPanel1 = new System.Windows.Forms.TableLayoutPanel();
			this.ucBars = new GCDUserInterface.ChangeDetection.ucChangeBars();
			this.Label5 = new System.Windows.Forms.Label();
			this.cboECDClass = new System.Windows.Forms.ComboBox();
			this.ucHistogram = new GCDUserInterface.ChangeDetection.ucDoDHistogram();
			...
			this.ucProperties = new GCDUserInterface.ChangeDetection.ucDoDProperties();
