...
namespace GCDUserInterface.ChangeDetection
{
	...
	partial class frmDoDProperties : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			//
			this.cmdBayesianProperties.Image = global::GCDUserInterface.My.Resources.Resources.Settings;
		...
		internal System.Windows.Forms.ComboBox cboNewDEM {
			get { return withEventsField_cboNewDEM; }
			set {
				if (withEventsField_cboNewDEM != null) {
					withEventsField_cboNewDEM.SelectedIndexChanged -= cboNewDEM_SelectedIndexChanged;
				}
				withEventsField_cboNewDEM = value;
				if (withEventsField_cboNewDEM != null) {
					withEventsField_cboNewDEM.SelectedIndexChanged += cboNewDEM_SelectedIndexChanged;
				}
			}
		...
		internal System.Windows.Forms.Button cmdBayesianProperties {
			get { return withEventsField_cmdBayesianProperties; }
			set {
				if (withEventsField_cmdBayesianProperties != null) {
					withEventsField_cmdBayesianProperties.Click -= cmdBayesianProperties_Click;
				}
				withEventsField_cmdBayesianProperties = value;
				if (withEventsField_cmdBayesianProperties != null) {
					withEventsField_cmdBayesianProperties.Click += cmdBayesianProperties_Click;
				}
			}
		}
		private System.Windows.Forms.CheckBox withEventsField_chkBayesian;
		internal System.Windows.Forms.CheckBox chkBayesian {
			get { return withEventsField_chkBayesian; }
			set {
				if (withEventsField_chkBayesian != null) {
					withEventsField_chkBayesian.CheckedChanged -= chkBayesian_CheckedChanged;
				}
				withEventsField_chkBayesian = value;
				if (withEventsField_chkBayesian != null) {
					withEventsField_chkBayesian.CheckedChanged += chkBayesian_CheckedChanged;
				}
			}
		}
		private System.Windows.Forms.NumericUpDown withEventsField_valConfidence;
		internal System.Windows.Forms.NumericUpDown valConfidence {
			get { return withEventsField_valConfidence; }
			set {
				if (withEventsField_valConfidence != null) {
					withEventsField_valConfidence.ValueChanged -= valConfidence_ValueChanged;
				}
				withEventsField_valConfidence = value;
				if (withEventsField_valConfidence != null) {
					withEventsField_valConfidence.ValueChanged += valConfidence_ValueChanged;
				}
			}
		...
		private System.Windows.Forms.RadioButton withEventsField_rdoProbabilistic;
		internal System.Windows.Forms.RadioButton rdoProbabilistic {
			get { return withEventsField_rdoProbabilistic; }
			set {
				if (withEventsField_rdoProbabilistic != null) {
					withEventsField_rdoProbabilistic.CheckedChanged -= rdoProbabilistic_CheckedChanged;
				}
				withEventsField_rdoProbabilistic = value;
				if (withEventsField_rdoProbabilistic != null) {
					withEventsField_rdoProbabilistic.CheckedChanged += rdoProbabilistic_CheckedChanged;
				}
			}
		}
		private System.Windows.Forms.RadioButton withEventsField_rdoPropagated;
		internal System.Windows.Forms.RadioButton rdoPropagated {
			get { return withEventsField_rdoPropagated; }
			set {
				if (withEventsField_rdoPropagated != null) {
					withEventsField_rdoPropagated.CheckedChanged -= rdoProbabilistic_CheckedChanged;
				}
				withEventsField_rdoPropagated = value;
				if (withEventsField_rdoPropagated != null) {
					withEventsField_rdoPropagated.CheckedChanged += rdoProbabilistic_CheckedChanged;
				}
			}
		}
		private System.Windows.Forms.RadioButton withEventsField_rdoMinLOD;
		internal System.Windows.Forms.RadioButton rdoMinLOD {
			get { return withEventsField_rdoMinLOD; }
			set {
				if (withEventsField_rdoMinLOD != null) {
					withEventsField_rdoMinLOD.CheckedChanged -= rdoProbabilistic_CheckedChanged;
				}
				withEventsField_rdoMinLOD = value;
				if (withEventsField_rdoMinLOD != null) {
					withEventsField_rdoMinLOD.CheckedChanged += rdoProbabilistic_CheckedChanged;
				}
			}
		...
		internal System.Windows.Forms.TextBox txtName {
			...
			set {
				if (withEventsField_txtName != null) {
					withEventsField_txtName.KeyDown -= txtName_KeyDown;
		...
		private System.Windows.Forms.ComboBox withEventsField_cboOldDEM;
		internal System.Windows.Forms.ComboBox cboOldDEM {
			get { return withEventsField_cboOldDEM; }
			set {
				if (withEventsField_cboOldDEM != null) {
					withEventsField_cboOldDEM.SelectedIndexChanged -= cboOldDEM_SelectedIndexChanged;
				}
				withEventsField_cboOldDEM = value;
				if (withEventsField_cboOldDEM != null) {
					withEventsField_cboOldDEM.SelectedIndexChanged += cboOldDEM_SelectedIndexChanged;
				}
			}
		...
		private System.Windows.Forms.NumericUpDown withEventsField_valMinLodThreshold;
		internal System.Windows.Forms.NumericUpDown valMinLodThreshold {
			get { return withEventsField_valMinLodThreshold; }
			set {
				if (withEventsField_valMinLodThreshold != null) {
					withEventsField_valMinLodThreshold.ValueChanged -= valConfidence_ValueChanged;
				}
				withEventsField_valMinLodThreshold = value;
				if (withEventsField_valMinLodThreshold != null) {
					withEventsField_valMinLodThreshold.ValueChanged += valConfidence_ValueChanged;
				}
			}
