...
Namespace Project
    ...
    Public Class ucProjectExplorer
        ...
        Private Sub LoadTree(Optional sSelectedNodeTag As String = "", Optional eSortSurveyBy As SortSurveyBy = SortSurveyBy.DEMSurveyID_Asc)
            ...
            Dim ds As ProjectDS = ProjectManagerBase.ds
            If Not TypeOf ds Is ProjectDS Then
                Exit Sub
            End If

            Dim dr As ProjectDS.ProjectRow = ProjectManagerBase.CurrentProject
            ...
            Try
                ...
                For Each rDoD As ProjectDS.DoDsRow In rProject.GetDoDsRows
                    ...
                    Else
                        ...
                        For Each rDEM As ProjectDS.DEMSurveyRow In ProjectManagerBase.ds.DEMSurvey
                ...
                If TypeOf theNode Is TreeNode Then
                    ...
                    Select Case eType
                        ...
                        Case GCDNodeTypes.ErrorSurface
                            Dim rError As ProjectDS.ErrorSurfaceRow = ProjectManagerBase.ds.ErrorSurface.FindByErrorSurfaceID(nID)
        ...
        Public Function AddDEMSurvey() As Integer
            ...
            If ProjectManagerBase.ds.DEMSurvey.Rows.Count > 0 Then
                gReferenceRaster = New GCDConsoleLib.Raster(ProjectManagerBase.GetAbsolutePath(ProjectManagerBase.ds.DEMSurvey.Item(0).Source))
            End If
            ...
            If frmImport.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If TypeOf gRaster Is GCDConsoleLib.Raster Then
                    ...
                    Dim sRelativeRasterPath As String = ProjectManagerBase.GetRelativePath(frmImport.txtRasterPath.Text)

                    Dim demRow As ProjectDS.DEMSurveyRow = ProjectManagerBase.ds.DEMSurvey.AddDEMSurveyRow(frmImport.txtName.Text, sRelativeRasterPath,
                    ...
                    Dim SurveyForm As New SurveyLibrary.frmDEMSurveyProperties(demRow.DEMSurveyID)
        ...
        Private Sub AddAllAssociatedSurfacesToTheMapToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles AddAllAssociatedSurfacesToTheMapToolStripMenuItem.Click
            ...
            Try
                ...
                If TypeOf selNode Is TreeNode Then
                    ...
                    If eType = GCDNodeTypes.AssociatedSurfaceGroup Then
                        Dim nParentID As Integer = GetNodeID(selNode.Parent)
                        Dim rDEMSurvey As ProjectDS.DEMSurveyRow = ProjectManagerBase.ds.DEMSurvey.FindByDEMSurveyID(nParentID)
        ...
        , DeriveErrorSurfaceToolStripMenuItem1.Click
            ...
            Try
                ...
                If TypeOf selNode Is TreeNode Then
                    ...
                    Dim rDEMSurvey As ProjectDS.DEMSurveyRow = ProjectManagerBase.ds.DEMSurvey.FindByDEMSurveyID(nID)
                    If TypeOf rDEMSurvey Is ProjectDS.DEMSurveyRow Then
            ...
            Try
                ...
                If TypeOf selNode Is TreeNode Then
                    ...
                    If eType = GCDNodeTypes.ErrorSurface Then
                        ...
                        Dim rError As ProjectDS.ErrorSurfaceRow = ProjectManagerBase.ds.ErrorSurface.FindByErrorSurfaceID(nErrorID)
                        If TypeOf rError Is ProjectDS.ErrorSurfaceRow Then
...
#Region "Inputs Group Menu Items"
        ...
        Private Sub AddAllDEMSurveysToTheMapToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles AddAllDEMSurveysToTheMapToolStripMenuItem.Click
            ...
            Try
                Dim rProject As ProjectDS.ProjectRow = ProjectManagerBase.CurrentProject
                If TypeOf rProject Is ProjectDS.ProjectRow Then
            ...
            Try
                ...
                If TypeOf selNode Is TreeNode Then
                    ...
                    If eType = GCDNodeTypes.DoD Then
                        ...
                        Dim rDoD As ProjectDS.DoDsRow = ProjectManagerBase.ds.DoDs.FindByDoDID(nID)
                        If TypeOf rDoD Is ProjectDS.DoDsRow Then
                            Dim dodResult As GCDCore.ChangeDetection.DoDResult = GCDCore.ChangeDetection.DoDResult.CreateFromDoDRow(rDoD)
...
#End Region
        ...
        Private Sub DeleteDEMSurvey(ByVal rDEMSurvey As ProjectDS.DEMSurveyRow)
            ...
            'Dim response As MsgBoxResult = MsgBox("Are you sure you want to remove the selected survey? Note this removes ALL FILES associated with this survey from the map and the project: digital elevation models, hillshades, associated surfaces, and error surfaces.", MsgBoxStyle.YesNo Or MsgBoxStyle.Question, GCDCore.Properties.Resources.ApplicationNameLong)
            'If response = MsgBoxResult.Yes Then
            ...
            '    Catch ex As Exception
            '        naru.error.ExceptionUI.HandleException(ex, "Some of the folders associated with this survey still exist because an ESRI lock file cannot be deleted while current ArcMap session is still running.")
            '    Finally
            '        rDEMSurvey.Delete()
            '        GCDProject.ProjectManagerBase.save()
            '    End Try
        ...
        DeleteAOIToolStripMenuItem.Click
            ...
            Select Case eType
                ...
                Case GCDNodeTypes.AssociatedSurface
                    ...
                    Dim rDEMSurvey As ProjectDS.DEMSurveyRow = ProjectManagerBase.ds.DEMSurvey.FindByDEMSurveyID(nDEMSurveyID)
                    For Each rAssoc As ProjectDS.AssociatedSurfaceRow In rDEMSurvey.GetAssociatedSurfaceRows
                        If rAssoc.AssociatedSurfaceID = nID Then
...
#End Region
        ...
        Private Sub btnAddToMap_Click(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            '    Select Case eType
            '        Case GCDNodeTypes.InputsGroup
            '            For Each rDEMSurvey As ProjectDS.DEMSurveyRow In GCDProject.ProjectManagerBase.CurrentProject.GetDEMSurveyRows
            '                GCDProject.ProjectManagerUI.ArcMapManager.AddDEM(rDEMSurvey)
            '                For Each rAssoc As ProjectDS.AssociatedSurfaceRow In rDEMSurvey.GetAssociatedSurfaceRows
            '                    GCDProject.ProjectManagerUI.ArcMapManager.AddAssociatedSurface(rAssoc)
            '                Next
            ...
            '        Case GCDNodeTypes.DoD
            '            For Each rDoD As ProjectDS.DoDsRow In GCDProject.ProjectManagerBase.ds.DoDs.Rows
            '            Next
            '    End Select
            ...
            Try
                ...
                If TypeOf selNode Is TreeNode Then
                    ...
                    If eType = GCDNodeTypes.Project Then
                        Process.Start("explorer.exe", IO.Path.GetDirectoryName(ProjectManagerBase.FilePath))
                    End If
                End If
            Catch ex As Exception
                naru.error.ExceptionUI.HandleException(ex)
                    ...
                    If GetNodeType(nodSelected) = GCDNodeTypes.ChangeDetectionDEMPair Then
                        ...
                        If Integer.TryParse(nodSelected.Tag.ToString.Substring(n1stUnderscore + 1, n2ndUnderscore - n1stUnderscore - 1), nNewDEMID) Then
                            If Integer.TryParse(nodSelected.Tag.ToString.Substring(n2ndUnderscore + 1, nodSelected.Tag.ToString.Length - n2ndUnderscore - 1), nOldDEMID) Then
                                ...
                                For Each aDEMRow As ProjectDS.DEMSurveyRow In ProjectManagerBase.ds.DEMSurvey
                                ...
                                If Not String.IsNullOrEmpty(sNewDEMName) Then
                                    If Not String.IsNullOrEmpty(sOldDEMName) Then
                                        For Each aDoDRow As ProjectDS.DoDsRow In ProjectManagerBase.ds.DoDs
                ...
                If TypeOf nodSelected Is TreeNode Then
                    ...
                    For Each rBS As ProjectDS.BudgetSegregationsRow In ProjectManagerBase.ds.BudgetSegregations
                        If rBS.BudgetID = nID Then
                            Dim sPath As String = ProjectManagerBase.GetAbsolutePath(rBS.OutputFolder).FullName
            ...
            Try
                ...
                If TypeOf nodSelected Is TreeNode Then
                    ...
                    Select Case eType
                        ...
                        Case GCDNodeTypes.ErrorSurfaceGroup
                            nID = GetNodeID(nodSelected.Parent)
                            For Each rDEM As ProjectDS.DEMSurveyRow In ProjectManagerBase.CurrentProject.GetDEMSurveyRows
