...
namespace GCDConsoleLib.GCD
{
    ...
    public partial class DoDStats
    {
        ...
        public decimal VolumeOfErosion_Percent { get { return DynamicMath.SafeDivision(ErosionErr.GetVolume(CellArea, StatsUnits.VertUnit), ErosionThr.GetVolume(CellArea, StatsUnits.VertUnit)) * 100; } }
        public decimal VolumeOfDeposition_Percent { get { return DynamicMath.SafeDivision(DepositionErr.GetVolume(CellArea, StatsUnits.VertUnit), DepositionThr.GetVolume(CellArea, StatsUnits.VertUnit)) * 100; } }
        ...
        public Length AverageDepthErosion_Raw { get { return DynamicMath.SafeDivision(ErosionRaw.GetVolume(CellArea, StatsUnits.VertUnit), ErosionRaw.GetArea(CellArea)); } }
        public Length AverageDepthErosion_Thresholded { get { return DynamicMath.SafeDivision(ErosionThr.GetVolume(CellArea, StatsUnits.VertUnit), ErosionThr.GetArea(CellArea)); } }
        public Length AverageDepthErosion_Error { get { return DynamicMath.SafeDivision(ErosionErr.GetVolume(CellArea, StatsUnits.VertUnit), ErosionThr.GetArea(CellArea)); } }
        ...
        public Length AverageDepthDeposition_Raw { get { return DynamicMath.SafeDivision(DepositionRaw.GetVolume(CellArea, StatsUnits.VertUnit), DepositionRaw.GetArea(CellArea)); } }
        public Length AverageDepthDeposition_Thresholded { get { return DynamicMath.SafeDivision(DepositionThr.GetVolume(CellArea, StatsUnits.VertUnit), DepositionThr.GetArea(CellArea)); } }
        public Length AverageDepthDeposition_Error { get { return DynamicMath.SafeDivision(DepositionErr.GetVolume(CellArea, StatsUnits.VertUnit), DepositionThr.GetArea(CellArea)); } }
        ...
        public decimal PercentErosion_Raw { get { return 100 * DynamicMath.SafeDivision(ErosionRaw.GetVolume(CellArea, StatsUnits.VertUnit), VolumeOfDifference_Raw); } }
        public decimal PercentErosion_Thresholded { get { return 100 * DynamicMath.SafeDivision(ErosionThr.GetVolume(CellArea, StatsUnits.VertUnit), VolumeOfDifference_Thresholded); } }
        public decimal PercentDeposition_Raw { get { return 100 * DynamicMath.SafeDivision(DepositionRaw.GetVolume(CellArea, StatsUnits.VertUnit), VolumeOfDifference_Raw); } }
        public decimal PercentDeposition_Thresholded { get { return 100 * DynamicMath.SafeDivision(DepositionThr.GetVolume(CellArea, StatsUnits.VertUnit), VolumeOfDifference_Thresholded); } }
